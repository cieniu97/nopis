...
<div id="files">
    ...
    <div class="tabela-files">
      ...
      <div class="tabela-opis komurka">Pliki</div>
        ...
        <div class="komurka">{{$file->nazwa}}</div>
        ...
        <div class="komurka">
          <div class="data-opis">
            ...
            <form class="" action="/nopis/public/files/download/{{$file->id}}" method="get">
                @csrf
    ...
    <div class="formularz">
        <form class="" action="/nopis/public/files/search" method="post">
